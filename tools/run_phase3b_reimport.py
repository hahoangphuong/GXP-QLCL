...
def main() -> int:
    ...
    database_path = ROOT / "artifacts" / "phase3b" / "staging_remediated.db"
    report_path = ROOT / "artifacts" / "phase3b" / "reconciliation.md"
    json_path = ROOT / "artifacts" / "phase3b" / "reconciliation.json"
    override_path = ROOT / "artifacts" / "phase3b" / "remediation_overrides.json"
