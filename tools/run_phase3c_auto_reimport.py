...
def main() -> int:
    ...
    database_path = ROOT / "artifacts" / "phase3c" / "staging_auto_remediated.db"
    report_path = ROOT / "artifacts" / "phase3c" / "reconciliation_auto.md"
    json_path = ROOT / "artifacts" / "phase3c" / "reconciliation_auto.json"
    override_path = ROOT / "artifacts" / "phase3c" / "remediation_overrides.auto.json"
