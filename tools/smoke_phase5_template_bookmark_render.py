...
def _build_bookmark_template_bytes() -> bytes:
...
<w:document xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main">
  <w:body>
    ...
    <w:p>
      <w:r><w:t>NgayQDKT: </w:t></w:r>
      <w:bookmarkStart w:id="2" w:name="NgayQDKT"/>
      <w:r><w:t>PLACEHOLDER_NGAY</w:t></w:r>
      <w:bookmarkEnd w:id="2"/>
    </w:p>
    <w:p>
      <w:r><w:t>TT2: </w:t></w:r>
      <w:bookmarkStart w:id="3" w:name="TT2"/>
      <w:r><w:t>PLACEHOLDER_TT2</w:t></w:r>
...
<cp:coreProperties xmlns:cp="http://schemas.openxmlformats.org/package/2006/metadata/core-properties"
 ...
 xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  <dc:title>Template Bookmark Render Smoke</dc:title>
</cp:coreProperties>""",
        )
        archive.writestr(
            "docProps/app.xml",
...
<Properties xmlns="http://schemas.openxmlformats.org/officeDocument/2006/extended-properties"
 xmlns:vt="http://schemas.openxmlformats.org/officeDocument/2006/docPropsVTypes">
  <Application>Codex GxP Template Smoke</Application>
</Properties>""",
        )
...
def main() -> None:
    ...
    smoke_root = ROOT / "artifacts" / "phase5" / "_smoke_template_bookmark_render"
    ...
    try:
        ...
        template_path.write_bytes(_build_bookmark_template_bytes())
            ...
            result = render_template_aware_docx_generation(
                ...
                DocumentPreparationInput(
                    request=DocumentGenerationRequest(
                        ...
                        idempotency_key="smoke-phase5-template-bookmark-render",
                    ),
                    payload_values={
                        "QDKT": "12/QD",
                        "NgayQDKT": "2024-01-15",
            ...
            json.dumps(
                {
                    ...
                    "contains_ngayqdkt": "2024-01-15" in document_xml,
                    "contains_tt2": "Doan kiem tra" in document_xml,
                    "placeholder_removed": "PLACEHOLDER_QDKT" not in document_xml,
                },
                ensure_ascii=False,
                indent=2,
            )
