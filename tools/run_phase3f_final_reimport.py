...
def main() -> int:
    ...
    database_path = ROOT / "artifacts" / "phase3f" / "staging_final.db"
    report_path = ROOT / "artifacts" / "phase3f" / "reconciliation_final.md"
    json_path = ROOT / "artifacts" / "phase3f" / "reconciliation_final.json"
    override_path = ROOT / "artifacts" / "phase3f" / "final_merged_overrides.json"
