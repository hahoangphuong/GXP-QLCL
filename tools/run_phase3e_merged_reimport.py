...
def main() -> int:
    ...
    database_path = ROOT / "artifacts" / "phase3e" / "staging_merged.db"
    report_path = ROOT / "artifacts" / "phase3e" / "reconciliation_merged.md"
    json_path = ROOT / "artifacts" / "phase3e" / "reconciliation_merged.json"
    override_path = ROOT / "artifacts" / "phase3e" / "merged_overrides.json"
