...
def main() -> int:
    ...
    database_path = ROOT / "artifacts" / "phase3i" / "staging_external.db"
    report_path = ROOT / "artifacts" / "phase3i" / "reconciliation_external.md"
    json_path = ROOT / "artifacts" / "phase3i" / "reconciliation_external.json"
    override_path = ROOT / "artifacts" / "phase3h" / "merged_overrides.external.json"
