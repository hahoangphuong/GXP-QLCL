...
def _build_header_footer_template_bytes() -> bytes:
    document_xml = """<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<w:document xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main"
 xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships">
  <w:body>
    <w:p>
      <w:r><w:t>Body QDKT: </w:t></w:r>
...
<w:hdr xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main">
  <w:p>
    <w:r><w:t>Header TT2: </w:t></w:r>
    <w:bookmarkStart w:id="2" w:name="TT2"/>
    <w:r><w:t>HEADER_PLACEHOLDER</w:t></w:r>
...
<w:ftr xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main">
  <w:p>
    <w:r><w:t>Footer NgayQDKT: </w:t></w:r>
    <w:bookmarkStart w:id="3" w:name="NgayQDKT"/>
    <w:r><w:t>FOOTER_PLACEHOLDER</w:t></w:r>
...
<cp:coreProperties xmlns:cp="http://schemas.openxmlformats.org/package/2006/metadata/core-properties"
 ...
 xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  <dc:title>Header Footer Render Smoke</dc:title>
</cp:coreProperties>""",
        )
        archive.writestr(
            "docProps/app.xml",
...
<Properties xmlns="http://schemas.openxmlformats.org/officeDocument/2006/extended-properties"
 xmlns:vt="http://schemas.openxmlformats.org/officeDocument/2006/docPropsVTypes">
  <Application>Codex GxP Header Footer Smoke</Application>
</Properties>""",
        )
...
def main() -> None:
    ...
    smoke_root = ROOT / "artifacts" / "phase5" / "_smoke_header_footer_render"
    ...
    try:
        ...
        template_path.write_bytes(_build_header_footer_template_bytes())
            ...
            result = render_template_aware_docx_generation(
                ...
                DocumentPreparationInput(
                    request=DocumentGenerationRequest(
                        ...
                        idempotency_key="smoke-phase5-header-footer-render",
                    ),
                    payload_values={
                        "QDKT": "12/QD",
                        "NgayQDKT": "2024-01-15",
            ...
            json.dumps(
                {
                    ...
                    "body_replaced": "12/QD" in document_xml,
                    "header_replaced": "Doan kiem tra" in header_xml,
                    "footer_replaced": "2024-01-15" in footer_xml,
                    "header_placeholder_removed": "HEADER_PLACEHOLDER" not in header_xml,
                    "footer_placeholder_removed": "FOOTER_PLACEHOLDER" not in footer_xml,
                },
                ensure_ascii=False,
                indent=2,
            )
